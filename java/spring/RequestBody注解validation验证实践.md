...
public class HelloController {
    ...
    public String hello(@Validated @RequestBody HelloDTO helloDTO) {
...
public class GlobalExceptionHandler {
    ...
    public String validationBodyException(MethodArgumentNotValidException exception) {
        ...
        log.warn("Data check failure : object={}, errorMessage={}", result.getObjectName(), sb.toString());
        return sb.toString();
    }
}
```
